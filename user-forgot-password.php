...
<head>
  ...
  <title>Central Library | Forget Password</title>
  ...
  <div class="content-wrapper">
    <div class="container">
      <div class="row pad-botm">
        <div class="col-md-12">
          <img src="./assets/img/forget.png" class="img-responsive" style="height: 40px;" alt="Add category" srcset="">
...
"></script>
  <script>
    new TypeIt('.title', {
      strings: 'User Password Recovery',
      speed: 50,
