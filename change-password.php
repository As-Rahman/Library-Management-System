...
?>
  ...
  <head>
    ...
    <title>Central Library | Change Password</title>
    ...
    <div class="content-wrapper">
      <div class="container">
        <div class="row pad-botm">
          <div class="col-md-12">
            <img src="./assets/img/change_pass.png" class="img-responsive" style="height: 40px;" alt="Add category" srcset="">
            <h4 class="header-line title">User Change Password</h4>
          </div>
        </div>
