...
?>
    ...
    <head>
        ...
        <title>Central Library | Student Signup</title>
        ...
        <div class="content-wrapper">
            <div class="container">
                <div class="row pad-botm">
                    <div class="col-md-12">
                        <img src="./assets/img/profile.png" class="img-responsive" style="height: 40px;" alt="Add category" srcset="">
                        <h4 class="header-line title">Update My Profile</h4>
